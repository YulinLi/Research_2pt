...
class PolicyNetGaussian(nn.Module):
    def __init__(self):
        ...
        # TODO1 : shape???
        self.fc1 = nn.Linear(96, 128)  # TODO1 shape
        self.fc2 = nn.Linear(128, 128)
        self.fc3 = nn.Linear(128, 128)
        # none change
        self.fc4_mean = nn.Linear(128, 4)
        self.fc4_logstd = nn.Linear(128, 4)

    def forward(self, s_img, s_cropped, s_cropped4):
        # full image conv
        ...
        img_cov5 = self.cropped_img_encoder(s_cropped4)
        """
        ...
        """
        # concat all
        s_full = torch.cat((img_cov1, img_cov2, img_cov5), 1)
        # print(s_full)
        # print(s_full.shape)
        # mirror to Q
    ...
    def sample(self, s_img, s_cropped1, s_cropped4):
        a_mean, a_logstd = self.forward(s_img, s_cropped1, s_cropped4)
        a_std = a_logstd.exp()
...
class QNet(nn.Module):
    ...
    def forward(self, s_img, s_cropped, s_cropped4, a):
